...
class TextStyles {
  ...
  static const stayConnectedStyle =
      TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white);
  static const exclusiveOffersStyle =
      TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Colors.white);
  static const signUpButtonStyle =
      TextStyle(fontSize: 15, fontWeight: FontWeight.w800, color: Colors.white);
  static const enterEmailStyle = TextStyle(
    color: Colors.white,
    fontWeight: FontWeight.bold,
  );
  static const drawerHeaderStyle = TextStyle(
    fontSize: 18,
    color: Colors.white,
